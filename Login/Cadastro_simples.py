...
class Manipulador():
    ...
    def on_button_cad_cadastrar_clicked(self, button):
        ...
        if nome != '':
            ...
            self.mensagem('Aviso', 'Usuario ' + nome + ' cadastrado!', 'dialog-emblem-default')
            
        else:
            self.mensagem('Aviso', 'Campo "Nome" obrigatorio!', 'dialog-error')
...
Builder = Gtk.Builder()
Builder.add_from_file("user_interface_login.glade")
